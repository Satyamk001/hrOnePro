...
export function SplashButton({
  text = "Sync",
  bgColor = "var(--color-primary-deep)",
    ...
    >
      <style>{`
        .sb-${uid} {
            ...
            --accent: ${accentColor};
            --text: ${textColor};
            --shadow: color-mix(in srgb, ${bgColor} 40%, transparent);
            --radius: 9999px;
        ...
        .sb-${uid}:hover .sb-content {
            box-shadow:
                inset -2px 12px 11px -5px color-mix(in srgb, var(--accent), transparent 20%),
                inset 1px -3px 11px 0px rgba(0,0,0,0.25);
        }
        ...
        .sb-${uid} .sb-loader {
            width: 22px;
            height: 22px;
            border: 3px solid color-mix(in srgb, var(--text) 25%, transparent);
            border-top-color: var(--text);
            border-radius: 50%;
            animation: sb-spin-${uid} 0.7s linear infinite;
        }
      `}</style>
